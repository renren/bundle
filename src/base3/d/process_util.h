...
#include "base3/file_descriptor_shuffle.h"
...
std::string GetProcessExecutablePath(ProcessHandle process);
...
bool LaunchApp(const std::string & command_line,
               bool wait, bool start_hidden, ProcessHandle* process_handle);
...
// indicating success).
bool GetAppOutput(const std::string & command_line, std::string* output);
...
// for the command.
bool GetAppOutputRestricted(const std::string & command_line,
